...
using J3DEditorAndViewer.UI.Renderer.Library;
...
namespace J3DEditorAndViewer.UI.Renderer
{
    ...
    internal class J3DObject : IRenderer
    {
...
";
        public J3DObject(J3DFileDialog j3d_FileDialog, int width, int height)
        {
            Width = width;
            Height = height;
            ...
            j3dVertexObject = new(j3d_FileDialog.J3DData2);
            ...
            VertexFactorys = new();
            foreach (var primitive in j3dVertexObject.primitives)
            {
                VertexFactorys.Add(new VertexFactory(primitive.ToVAOManager(), [UniformManagerProjection, UniformManagerMixer], glslTypeTrait, VShaderCode));
            }
            ...
            // Shaderは使い回すため、VertexFactorysより1つ選びます。
            Shader = new TestShader(VertexFactorys.ElementAt(0), FragmentFactory);
        ...
        private J3DVertexObject j3dVertexObject;
        ...
        private List<IVertexFactory> VertexFactorys;

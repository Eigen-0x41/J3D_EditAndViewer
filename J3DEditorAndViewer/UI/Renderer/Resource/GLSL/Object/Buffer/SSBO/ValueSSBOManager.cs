...
{
    internal class ValueSSBOManager<InT> : ISSBOManager<InT>
        where InT : struct
    {
        ...
        public ValueSSBOManager(string defineName, InT[] VertexData)
        {
        ...
        protected ValueSSBOManager(string defineName)
        {
            DefineName = defineName;
            data = new InT[1];
            isModified = true;
